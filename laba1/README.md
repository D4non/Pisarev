...
│   ├── PersonSerializerTests.cs      # Тесты для PersonSerializer
...
Программа последовательно выполнит демонстрацию работы всех классов:
1. **DemoPerson()** - демонстрация работы с классом Person
2. **DemoPersonSerializer()** - демонстрация сериализации/десериализации
3. **DemoFileResourceManager()** - демонстрация работы с файлами
