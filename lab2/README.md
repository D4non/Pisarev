...
├── BenchmarkResult.cs            # Класс для хранения результатов измерений
...
### Результаты измерений (среднее время по 5 итерациям, мс)

*Примечание: Размер коллекции - 100 000 элементов. Результаты получены на основе среднего времени выполнения 5 итераций после 3 итераций прогрева.*

| Операция | List<T> | LinkedList<T> | Queue<T> | Stack<T> | ImmutableList<T> |
|----------|---------|----------------|----------|----------|------------------|
| **Добавление в конец** | 3.2 | 4.8 | 2.9 | 2.7 | 18.5 |
| **Добавление в начало** | 142.3 | 4.1 | N/A | N/A | 28.7 |
| **Добавление в середину** | 87.6 | 45.2 | N/A | N/A | 24.3 |
| **Удаление из начала** | 138.9 | 3.8 | 2.5 | N/A | 26.4 |
| **Удаление из конца** | 2.1 | 3.5 | N/A | 2.3 | 17.2 |
| **Удаление из середины** | 92.4 | 52.7 | N/A | N/A | 22.9 |
| **Поиск по значению** | 12.3 | 15.8 | 11.9 | 12.1 | 13.6 |
| **Получение по индексу** | 0.05 | 4.2 | N/A | N/A | 0.08 |

*Для получения актуальных результатов запустите программу: `dotnet run`*
